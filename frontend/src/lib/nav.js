import {
  LayoutDashboard, Key, Gauge, Cpu, Settings as SettingsIcon, FileText, FlaskConical,
} from '@lucide/svelte';
...
export const NAV_ITEMS = [
  { id: 'overview', component: Overview, label: 'Overview', icon: LayoutDashboard },
  ...
  { id: 'settings', component: Settings, label: 'Settings', icon: SettingsIcon },
  { id: 'logs', component: Logs, label: 'Logs', icon: FileText },
  { id: 'devtools', component: DevTools, label: 'Dev Tools', icon: FlaskConical, gate: 'devtools' },
