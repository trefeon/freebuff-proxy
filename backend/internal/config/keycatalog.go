...
var keyCatalog = []KeyDef{
	...
	{Key: "MATURITY_ENABLED", Group: GroupPool, Kind: "bool", Essential: true,
		Default:     "true",
		Description: `Global kill-switch for streak-maturity automation: daily low-cost touches that keep locked tokens' streaks alive until their target. Default true (probes run in dry-run mode); set false to disable all automated touches.`},
