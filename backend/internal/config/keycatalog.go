...
var keyCatalog = []KeyDef{
	...
	{Key: "DASHBOARD_ENABLED", Group: GroupGeneral, Kind: "bool",
		Default:     "true",
	...
	{Key: "LOG_FILE", Group: GroupGeneral, Kind: "text",
		Default:     "",
	...
	{Key: "WEBHOOK_URL", Group: GroupSecurity, Kind: "text", Secret: true, RestartOnly: true,
		Default:     "",
