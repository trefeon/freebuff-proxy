...
func AdminAPIPaths() []AdminAPIPath {
	...
	return []AdminAPIPath{
		...
		{Method: "GET", Path: "/admin/api/logs", OperationID: "getLogs", Summary: "Recent log ring view model", Auth: "sensitive", Kind: AdminAPIKindJSON, Response: logsData{}, Query: []AdminAPIQuery{{Name: "level", Description: "Log level filter"}, {Name: "msg", Description: "Message substring filter"}, {Name: "window", Description: "View window override (Go duration, clamped to 1m..168h)"}}},
