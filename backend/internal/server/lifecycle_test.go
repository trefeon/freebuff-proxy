...
func TestLifecycleFullJourney(t *testing.T) {
	...
	t.Run("monitor", func(t *testing.T) {
		...
		allowed := map[string]bool{"unlimited session": true, "5 premium quota": true, "referral +1/day": true, "unmetered": true, "shared premium pool": true, "5/day shared premium": true, "metered — Freebucks/hr at session start": true}
