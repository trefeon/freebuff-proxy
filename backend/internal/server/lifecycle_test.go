...
func TestLifecycleFullJourney(t *testing.T) {
	...
	t.Run("monitor", func(t *testing.T) {
		...
		allowed := map[string]bool{"unlimited session": true, "6 premium quota": true, "referral +1/day": true, "unmetered": true, "shared premium pool": true, "5/day shared premium": true}
