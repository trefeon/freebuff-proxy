...
// configEnvKeys lists every environment variable backend/internal/config reads.
...
// Keep this in sync with every override* call in backend/internal/config/config.go.
var configEnvKeys = []string{
	...
	"SESSION_PROBE_CACHE_TTL", "MODEL_UNAVAILABLE_CACHE_TTL", "SESSION_CREATE_MAX_PARALLEL_GLOBAL",
